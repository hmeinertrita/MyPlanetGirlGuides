...
/******/ 	var hotCurrentHash = "4b3e4deadbe1596b6d1b"; // eslint-disable-line no-unused-vars
...
/******/ 			var chunk = require("./chunks/" + ({"0":"home","1":"login","2":"welcome","3":"results","4":"not-found","5":"search","6":"details"}[chunkId]||chunkId) + ".js");
...
const routes = {
  ...
  children: [{
    ...
    path: '/results',
    load: () => __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, "./src/routes/results/index.js"))
  }, {
    path: '/details',
